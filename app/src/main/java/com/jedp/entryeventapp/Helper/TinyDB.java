...
public class TinyDB {
    ...
    public ArrayList<EventosModel> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<EventosModel> playerList =  new ArrayList<EventosModel>();

        for(String jObjString : objStrings){
            EventosModel player  = gson.fromJson(jObjString,  EventosModel.class);
    ...
    public void putListObject(String key, ArrayList<EventosModel> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(EventosModel player: playerList){
